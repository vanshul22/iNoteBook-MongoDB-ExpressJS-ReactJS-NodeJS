...
const Notes = (props) => {
  ...
  return (
    <>
      <>
        <button type="button" className="btn btn-primary d-none" data-bs-toggle="modal" data-bs-target="#exampleModal" ref={refOpenModal}>
        </button>
        <div
      ...
      <div className='row my-3'>
        ...
        {notes.map((note) => <NoteItem key={note._id} note={note} updateNote={updateNote} showAlert={props.showAlert} />)}
      </div>
    </>
  );
};
